...
if(UserName!=null){
	 ...
	 Class.forName("com.mysql.jdbc.Driver");
	 	try(Connection con=DriverManager.getConnection(url,user,psswd)){
	 		PreparedStatement prp=con.prepareStatement("Select * from BuyerOrder where BuyerUserName=? and OrderDate>=NOW()-INTERVAL 2 MINUTE");;
...
<div class="order-summary">
    ...
    <button class="place-order-button" onclick="window.location.href='BuyerHomePage.jsp'">Go to home</button>
</div>
